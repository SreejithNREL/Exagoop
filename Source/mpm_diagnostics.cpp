...
amrex::Real MPMParticleContainer::CalculateExactVelocity(int modenumber,
                                                         amrex::Real E,
                                                         amrex::Real rho,
                                                         amrex::Real v0,
                                                         amrex::Real L,
...
void MPMParticleContainer::CalculateErrorTVB(
    Real tvb_E, Real tvb_v0, Real tvb_L, Real tvb_rho, Real err)
{
...
void MPMParticleContainer::WriteDeflectionTVB(
    Real tvb_E, Real tvb_v0, Real tvb_L, Real tvb_rho, Real time, int output_it)
{
    // Works only for serial runs
