...
_F = build_field_dict(2, True)          # DIM=2, USE_TEMP=TRUE build
C_X, C_Y = _F["posx"], _F["posy"]
C_STRESS = _F["stress"]                 # 6 components, 2-D Voigt order XX XY YY XZ YZ ZZ
C_VOLUME = _F["volume"]
C_DENSITY = _F["density"]
C_TEMPERATURE = _F["temperature"]
C_SPHEAT = _F["specific_heat"]
C_EP = _F["isv_0"]                      # JC equivalent plastic strain
C_DAMAGE = _F["isv_7"]                  # JC damage
