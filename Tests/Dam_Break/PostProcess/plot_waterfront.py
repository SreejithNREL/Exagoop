...
def main():
    ...
    parser.add_argument("--minmaxfile", type=str, default=5,
                        help="Number of metadata rows to skip")
    
    parser.add_argument("--expdata", type=str, default=5,
                        help="Number of metadata rows to skip")
    ...
    data=np.loadtxt(args.minmaxfile,skiprows=1)
    exp=np.loadtxt(args.expdata)
